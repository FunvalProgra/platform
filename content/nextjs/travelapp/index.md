...
4. ### **Historial de Búsquedas**
   ...
   - Almacenar las búsquedas recientes en el `localStorage` para que los usuarios puedan acceder rápidamente a sus búsquedas previas.
